...
//MARK:- makeDescKey 17-208 = 91-lines
...
//    }
    ...
    // [C2 - VANGUARD KITCHEN]  [REVERSE - DUP CREDIT - BLOOMINGDALES NEW] 9ok
    ...
    // Remove "INC", "LLC" -- [TREELANDS INC] -> [TREELANDS ];  [GUNDRY MD  LLC] -> [GUNDRY MD  ]
    key2 = descKeyLong.replacingOccurrences(of: #"\bINC\b|\bLLC\b"#, with: "", options: .regularExpression, range: nil)
...
func checkDif(newStr: String, oldStr: String, doPrint: Bool, comment: String) -> String {
    if oldStr != newStr {
        let algToPrint = 13   // CHANGE THIS NUMBER TO PRINT A PARTICULAR ALGORITHM
