...
public struct FileIO {
    ...
    // If calling Folder name is a 4-digit year (1980-2099) or "all" return parent. Else return same.
    static func getPossibleParentFolder(myURL: URL) -> URL {
        var pathURL = myURL
        let last = pathURL.lastPathComponent
        if last.lowercased() == "all" {
...
//---- writeModTransTofile - Save file MyModifiedTransactions.txt
