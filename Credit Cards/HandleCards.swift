...
func extractTranFromActivity(lineItem: LineItem) -> LineItem {  // 95-240 = 145-lines
...
//    } else if des.hasPrefix("CDIV:")                        { // "CDIV: DAF S AND P 500 TRUST 2 HOLDING 5X6398.0000 PAY DATE 01/09"
//    } else if des.hasPrefix("DIVIDEND:")                    { // "DIVIDEND: DISNEY (WALT) CO COM STK HOLDING 600.0000 PAY DATE 01/"
//    if des.hasPrefix("LIQUIDATING DIVIDEND:")               {   // "LIQUIDATING DIVIDEND: DAF S AND P 500 TRUST 2 HOLDING 5X6398.972"
//    } else if des.hasPrefix("FOREIGN DIVIDEND:")            {   // "FOREIGN DIVIDEND: SASOL LTD  SPONSORED ADR HOLDING 500.0000 PAY"
...
//    } else if des.hasPrefix("BOND INTEREST:")               {   // "BOND INTEREST: ADVISORS DISCIPLINED TR 532 TAX EXEMPT MUN PORT I"
//        known = true
//
//    } else if des.hasPrefix("BANK INTEREST:")               {   // "BANK INTEREST: ML BANK DEPOSIT PROGRAM"
//        known = true
//
//    } else if des.hasPrefix("INTEREST:")                    {   // "INTEREST: ADVISORS DISCIPLINED TR 532 TAX EXEMPT MUN PORT INTERM"
//        known = true
    ...
    } else if des.hasPrefix("RPT FGN DIV:")                 {   // RPT FGN DIV: MEDTRONIC PLC SHS HOLDING 600.0000 PAY DATE 01/13/2
        known = true
...
//MARK: makeLineItem 263-369 = 106-lines
