...
func handleCards(fileName: String, cardType: String, cardArray: [String]) -> [LineItem] {
    ...
    //MARK: Read Transactions 65-157 = 92-lines
...
func makeLineItem(tran: String, dictColNums: [String: Int], hasCatHeader: Bool, cardType: String, fileName: String, lineNum: Int) -> LineItem {
