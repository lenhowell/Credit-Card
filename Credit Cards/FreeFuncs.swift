...
//    }
    ...
    if posX >= 0 {
        ...
        if posX >= 2 {
            ...
            descKeyLong = checkDif(newStr: key2, oldStr: descKeyLong, doPrint: true, comment: "Remove \"xxx...\"")
        } else {
            let x=1 // Debug Trap
        }
    }
    ...
    if posHash >= 0 {
        ...
        if posHash >= 2 {
            ...
            descKeyLong = checkDif(newStr: key2, oldStr: descKeyLong, doPrint: true, comment: "Remove \"#...\"")
        } else {
            let x=1 // Debug Trap
        }
    }
