...
class Credit_Cards_UnitTests: XCTestCase {
    ...
    """
    Transaction Date,Posted Date,Card No.,Description,Category,Debit,Credit
    2019-08-08,2019-08-10,9442,BEACH COVE RESORT F&B,Dining,27.59,
    2019-08-10,2019-08-10,9442,CAPITAL ONE AUTOPAY PYMT,Payment/Credit,,24.00
    """
 ...
 */
    ...
    func testHandleCards() {
        ...
        var lineItemArray = handleCards(fileName: "fileName", cardType: "cardType", cardArray: cardArrayC1R)
        ...
        //Uses "Date" in header & no "Description"
